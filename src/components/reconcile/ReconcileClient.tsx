...
// The Audit page's UI. Moved out of app/[locale]/reconcile/page.tsx (2026-08-12)
// so that route could become a SERVER component and gate on the internal
// allowlist before any of this reaches the browser — see that file's header.
// Nothing below changed except the removal of the Pro paywall branch, which
// this page no longer has: it is not sold, it is not shown.
